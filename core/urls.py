...
from .views import  ProductList, updatedToPaid ,ProductDetail, getUsers, getOrderById ,registerUser, addOrderItem
...
urlpatterns = [
    ...
    path("updatepaid/<pk>", updatedToPaid, name="updatepaid")
]
